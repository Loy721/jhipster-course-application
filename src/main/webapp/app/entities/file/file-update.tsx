  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterCourseApp.file.home.createOrEditLabel" data-cy="FileCreateUpdateHeading">
            <Translate contentKey="jhipsterCourseApp.file.home.createOrEditLabel">Create or edit a File</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('jhipsterCourseApp.file.topic')} id="file-topic" name="topic" data-cy="topic" type="text" />
              <ValidatedField
                label={translate('jhipsterCourseApp.file.content')}
                id="file-content"
                name="content"
                data-cy="content"
                type="text"
