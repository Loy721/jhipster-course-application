  ...
  return (
    <div>
      <h2 id="file-heading" data-cy="FileHeading">
        <Translate contentKey="jhipsterCourseApp.file.home.title">Files</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipsterCourseApp.file.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/file/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterCourseApp.file.home.createLabel">Create new File</Translate>
          </Link>
        </div>
      </h2>
        ...
        {fileList && fileList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhipsterCourseApp.file.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('topic')}>
                  <Translate contentKey="jhipsterCourseApp.file.topic">Topic</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('topic')} />
                </th>
                <th className="hand" onClick={sort('content')}>
                  <Translate contentKey="jhipsterCourseApp.file.content">Content</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterCourseApp.file.home.notFound">No Files found</Translate>
            </div>
          )
        )}
      </div>
