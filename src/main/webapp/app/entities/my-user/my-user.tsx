  ...
  return (
    <div>
      <h2 id="my-user-heading" data-cy="MyUserHeading">
        <Translate contentKey="jhipsterCourseApp.myUser.home.title">My Users</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipsterCourseApp.myUser.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/my-user/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterCourseApp.myUser.home.createLabel">Create new My User</Translate>
          </Link>
        </div>
      </h2>
        ...
        {myUserList && myUserList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhipsterCourseApp.myUser.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="jhipsterCourseApp.myUser.name">Name</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('name')} />
                </th>
                <th className="hand" onClick={sort('surname')}>
                  <Translate contentKey="jhipsterCourseApp.myUser.surname">Surname</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterCourseApp.myUser.home.notFound">No My Users found</Translate>
            </div>
          )
        )}
      </div>
