  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterCourseApp.question.home.createOrEditLabel" data-cy="QuestionCreateUpdateHeading">
            <Translate contentKey="jhipsterCourseApp.question.home.createOrEditLabel">Create or edit a Question</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterCourseApp.question.content')}
                id="question-content"
                name="content"
                data-cy="content"
                type="text"
              ...
              <ValidatedField
                ...
                name="myTest"
                data-cy="myTest"
                label={translate('jhipsterCourseApp.question.myTest')}
                type="select"
              >
                <option value="" key="0" />
                {myTests
