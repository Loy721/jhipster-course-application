...
export const QuestionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterCourseApp.question.delete.question">
        <Translate contentKey="jhipsterCourseApp.question.delete.question" interpolate={{ id: questionEntity.id }}>
