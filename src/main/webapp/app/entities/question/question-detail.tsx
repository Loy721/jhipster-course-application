    ...
    <Row>
      <Col md="8">
        <h2 data-cy="questionDetailsHeading">
          <Translate contentKey="jhipsterCourseApp.question.detail.title">Question</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="jhipsterCourseApp.question.myTest">My Test</Translate>
          </dt>
