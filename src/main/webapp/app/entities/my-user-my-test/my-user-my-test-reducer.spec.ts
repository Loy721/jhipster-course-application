...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MYUSERMYTEST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MYUSERMYTEST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MYUSERMYTEST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MYUSERMYTEST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MYUSERMYTEST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MYUSERMYTEST actions', async () => {
      const arg = 42666;
